...
var resource = function(game) {
	this.game       = game;
	this.bar        = new gameImage('bar'); // thanh cho gà đậu
	this.bowl       = new gameImage('bowl'); // bát hứng trứng
	this.chicken    = new gameImage('chicken');
	this.egg1       = new gameImage('egg1'); // loại trứng
	this.egg2       = new gameImage('egg2'); // loại trứng
